...
typedef uint32_t MIPSOpcode;

#define _VD (op->instruction & 0x7F)
#define _VS ((op->instruction>>8) & 0x7F)
#define _VT ((op->instruction>>16) & 0x7F)

#define __VD (opcode & 0x7F)
#define __VS ((opcode>>8) & 0x7F)
#define __VT ((opcode>>16) & 0x7F)
